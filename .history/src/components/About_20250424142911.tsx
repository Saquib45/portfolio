      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            My journey began with a strong focus on Data Structures and Algorithms, where I honed my problem-solving skills and built a solid coding foundation.
            This logical mindset naturally extended into web development, where I now create dynamic, user-friendly applications using both frontend and backend technologies.
As a full-stack developer, I combine algorithmic thinking with practical development to build efficient and impactful digital solutions..
            </p>
            <p className="text-gray-300 mb-6">
