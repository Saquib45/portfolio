...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: "A productivity application for organizing tasks with drag-and-drop functionality, filters, and team collaboration features. 
      A real-time chat application enabling seamless one-to-one and group messaging with instant delivery.
