...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: "A dynamic web platform built to streamline the organization of college sports events, including registration, scheduling, and result tracking.Offers a user-friendly interface for participants, coordinators, and admins to manage event details efficiently.Developed using modern web technologies with responsive design for accessibility across devices.A dynamic web platform built to streamline the organization of college sports events, including registration, scheduling, and result tracking.
