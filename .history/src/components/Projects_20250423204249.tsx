...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    {
      id: 1,
      title: "Smart Contact Manager",A fully responsive e-commerce platform with product filtering, user authentication, cart functionality, and payment integration
      description: ".",
