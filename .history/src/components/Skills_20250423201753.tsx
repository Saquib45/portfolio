...
const Skills: React.FC = () => {
  ...
  const skills: Skill[] = [
    ...
    { name: 'Tailwind', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original-wordmark.svg', category: 'frontend' },
    ...
    { name: 'Django', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/devicon.min.css', category: 'backend' },
    ...
    { name: 'AWS', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original.svg', category: 'tools' },
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-400 max-w-3xl mx-auto">
            ...
            From frontend frameworks to backend technologies, databases, and DevOps tools.
          </p>
        </div>
