...
const Education: React.FC = () => {
  ...
  const education: EducationItem[] = [
    ...
    },
    {
      ...
      period: "Regularly",
      description: "My learning journey began with mastering Data Structures and Algorithms, building a strong foundation in problem-solving and logic.
Alongside, I explored Web Development, gaining hands-on experience with HTML, CSS, JavaScript, and modern frameworks like React and Spring Boot.
